...
pub use varnish_sys::{ vrt_ctx, vmod_priv, vcl_event_e, VMOD_ABI_Version, VRT_MINOR_VERSION, VRT_MAJOR_VERSION , VCL_ACL , VCL_BACKEND , VCL_BLOB , VCL_BODY , VCL_BOOL , VCL_BYTES , VCL_DURATION , VCL_ENUM , VCL_HEADER , VCL_HTTP , VCL_INT , VCL_IP , VCL_PROBE , VCL_REAL , VCL_STEVEDORE , VCL_STRANDS , VCL_STRING , VCL_TIME , VCL_VOID };
